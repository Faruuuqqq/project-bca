...
// Dynamically import the chart component to avoid loading Recharts upfront
const HourlyChart = dynamic(
  () => import('@/components/admin/HourlyChart').then((mod) => mod.HourlyChart),
  {
    loading: () => (
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <HourlyChart
          hourlyData={stats.operations.hourlyData}
          range={stats.range}
          orderCount={stats.financials.orders}
        />
